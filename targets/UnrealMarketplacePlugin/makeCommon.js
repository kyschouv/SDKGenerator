...
exports.makeCommonCombinedAPI = function (apis, copyright, sourceDir, apiOutputDir) {
    var locals = {
        apis: apis,
    ...
    var subFolders = ["PlayFabPlugin"]; // Two copies, one for example project, and one as the raw plugin
