...
exports.makeBpCombinedAPI = function (apis, copyright, sourceDir, apiOutputDir) {
    apiOutputDir = path.join(apiOutputDir, "PlayFabPlugin");
    makeApiIntermal(apis, copyright, sourceDir, apiOutputDir, "All");
}

function makeApiIntermal(apis, copyright, sourceDir, apiOutputDir, libName) {
